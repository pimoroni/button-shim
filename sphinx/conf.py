...
PACKAGE_NAME = u"Button SHIM"
PACKAGE_HANDLE = "ButtonSHIM"
PACKAGE_MODULE = "buttonshim"
...
version = u'{}'.format(buttonshim.__version__)
# The full version, including alpha/beta/rc tags.
release = u'{}'.format(buttonshim.__version__)
